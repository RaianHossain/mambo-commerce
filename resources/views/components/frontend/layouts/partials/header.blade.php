            ...
            <div class="header-top">
                <div class="container">
                    ...
                    <div class="header-right">
                        ...
                        <a href="contact-us.html" class="contact d-lg-show mr-0"><i class="d-icon-map"></i>Contact
                            Us</a>
                        <span class="divider d-lg-show"></span>
            ...
            <div class="header-middle sticky-header fix-top sticky-content">
                <div class="container">
                    ...
                    <div class="header-center d-flex d-lg-none flex-1 justify-content-center">
                        <a href="demo4.html" class="logo mr-0">
                            <img src="images/demos/demo4/logo.png" alt="logo" width="154" height="43" />
                        </a>
                    </div>
                    <div class="header-right">
                        <a href="tle:#" class="icon-box icon-box-side mr-6 d-xl-show">
                        ...
                        <a class="login-link" href="ajax/login.html" data-toggle="login-modal" title="login"><i
